...
enum {
  ...
  anon_sym_94 = 193,
  sym_comment = 194,
  aux_sym_z_token1 = 195,
  aux_sym_z_token2 = 196,
  aux_sym_z_token3 = 197,
  sym_str = 198,
  anon_sym_true = 199,
  anon_sym_false = 200,
  anon_sym_95 = 201,
  ...
  switch (state) {
    case 0:
      ...
      if (('A' <= lookahead && lookahead <= 'z') ||
          ...
          (11264 <= lookahead && lookahead <= 55295)) ADVANCE(108);
      END_STATE();
    case 1:
